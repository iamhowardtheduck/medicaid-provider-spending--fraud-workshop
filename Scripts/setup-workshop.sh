...
curl -X POST "http://localhost:30002/api/kibana/settings" -H "Content-Type: application/json" -H "kbn-xsrf: true" -u "fraud:hunter" -d '{"changes": {"defaultIndex": "fraud-medicaid-workshop" } }'
